...
//    console.log(cartProducts)
    return ( 
        <div className="">
            ...
            {toggle && (
                <div className="absolute left-1/2 transform -translate-x-1/2 w-11/12 top-10 md:transform-none md:left-auto md:right-16 md:w-64 px-4 py-6 border border-borderLight bg-white flex flex-col gap-8">
